...
### CSS1
&emsp;&emsp;W3C组织在1996年发布了最早的一个CSS规范（CSS specification）**CSS1**。

&emsp;&emsp;同一年微软公司作为最早的浏览器厂商之一发布了IE3浏览器，对CSS1规范作出了比较简单的支持。随后几年，各个浏览器厂商都在自己生产的浏览中逐步引入对CSS1规范的支持。直到2000年3月份，微软推出了Internet Explorer 5.0 for the Macintosh，这个世界上才是真正有了第一个完全支持（超过99%）CSS1规范的浏览器。
...
&emsp;&emsp;大家请注意，早在第一个完全支持CSS1的浏览器两年之前，W3C组织就已经发布了**CSS2**规范。

&emsp;&emsp;无奈，规范是一回事，对规范的支持又是另一回事；我们可以把W3C组织比作我国春秋战国时期的周天子，把各大浏览器厂商比作实力派地方诸侯。虽说周天子作为天下共主具有礼仪和制度上的无上权威，并且把**周礼**发布为规范，但是最终是否执行规范、如何执行规范这样的问题还是取决于地方诸侯的实际需要。同样，CSS规范的执行也总是受制于浏览器市场的发展情况和各大浏览器厂商的商业计划。

&emsp;&emsp;常言道，“**发展才是硬道理**”，慢慢的，他们真真切切看到了CSS2规范在互联网大潮中的诱人前景，也心知肚明唯有主动发展才可以避免被历史淘汰，认真考虑并且逐步实现对CSS2规范的支持就成了各大实力派厂商的不二选择。

&emsp;&emsp;CSS2.1是现今互联网(Internet)上受到最广泛支持的规范。它修复了CSS2规范中的一些Bug，删除和添加了一些特性。根据W3C的工作流程，这个版本经过了长时间的反复修订，甚至直到2010年12月份还被退回到**最后的工作草稿**状态接受审议。2011年7月份才被最后一次正式发布给浏览器厂商。至此，CSS2.1规范尘埃落定。
...
&emsp;&emsp;CSS要干的事情只有两件，第一是找到HTML元素，第二就是修改元素的样式属性。

&emsp;&emsp;CSS常用样式看起来是一个属性还有属性取值范围的清单，但是任何一个已知的HTML元素都不会支持所有的CSS属性，这一点由CSS规范里面定义好的CSS属性的含义决定。
