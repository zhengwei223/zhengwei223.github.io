...
&emsp;&emsp;完成之后打开浏览器可以看到：
 ...
 ![js_regexp_tutorial_filter_number](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number.png)
...
&emsp;&emsp;在页面上输入内容，测试过滤效果：
 ...
 ![js_regexp_tutorial_filter_number_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_02.gif)
...
&emsp;&emsp;找到JS示例代码中的第6行，把它替换成下面的内容：
 ...
 ![js_regexp_tutorial_filter_number_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_03.gif)
...
&emsp;&emsp;刷新页面重新测试，可以看到：
 ...
 ![js_regexp_tutorial_filter_number_04](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_04.gif)
...
&emsp;&emsp;在控制台输入以上代码，回车确认执行，可以看到：
 ...
 ![js_regexp_tutorial_demo_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_05.gif)
...
&emsp;&emsp;位于字面量表达式结尾处的斜杠之后，可以关联一个或者多个正则表达式的标志。例如，在实验一里用于过滤数字的正则表达式字面量里面就关联了一个“g”字母，表示我们希望匹配出字符里面的全部数字——全局匹配。
 ...
 ![js_regexp_tutorial_filter_number_08](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_08.png)
...
&emsp;&emsp;在控制台输入以上代码，回车确认执行，可以看到：
 ...
 ![js_regexp_tutorial_filter_number_06](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_06.gif)
...
### 使用由字面量语法定义的正则表达式对象
 ...
 ![js_regexp_tutorial_filter_number_07](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_07.gif)

### 使用由构造函数创建的正则表达式对象

 ![js_regexp_tutorial_filter_number_09](http://lemon.lanqiao.org:8082/teaching/img/js/js_regexp_tutorial_filter_number_09.gif)
...
&emsp;&emsp;刷新页面之后可以看到
 ...
 ![js_regform_required_input_tag](http://lemon.lanqiao.org:8082/teaching/img/js/js_regform_required_input_tag.png)
...
&emsp;&emsp;大家可以打开名称为“[TODO]regFormValid.js”的文件：
 ...
 ![js_reg_form_validation_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_reg_form_validation_01.gif)
...
&emsp;&emsp;有关这个事件属性，大家可以查看[W3School HTML form onsubmit](http://www.w3school.com.cn/tags/event_onsubmit.asp)页面。
 ...
 ![js_reg_form_validation_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_reg_form_validation_02.gif)
...
&emsp;&emsp;请在控制台输入下面的代码：
 ...
 ![js_reg_form_validation_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_reg_form_validation_03.gif)
...
&emsp;&emsp;网络上有很多网友们已经写好的正则表达式。大家可以查看：

1. [在线正则表达式测试](http://tool.chinaz.com/tools/regexgenerate)页面，
2. [常用正则表达式](http://ccvita.com/61.html)页面
...
&emsp;&emsp;你只需要在http地址的字符串末尾输入代表其他国家名称的两位ISO标准编码，就可以得到一个记录了该国完整名称的JSON格式数据。
 ...
 ![js_data_inter_change_json_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_01.gif)

&emsp;&emsp;把页面返回的JSON格式数据复制下来，在文本编辑器里面另存为后缀名是“.json”的文件。

 ![js_data_inter_change_json_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_02.gif)

### 从网上获取JSON格式数据

&emsp;&emsp;新建一个空白HTML文件，用于演示JSON格式数据的转换。

 ![js_data_inter_change_json_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_03.gif)
...
&emsp;&emsp;刷新页面以后在控制台输出服务器返回的数据格式：
 ...
 ![js_data_inter_change_json_04](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_04.gif)
...
&emsp;&emsp;重新刷新页面，检查控制台可以看到：
 ...
 ![js_data_inter_change_json_05](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_05.gif)
...
&emsp;&emsp;新建一个后缀名是“.json”的文本文件，保存以上内容。
 ...
 ![js_data_inter_change_json_06](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_06.gif)

&emsp;&emsp;打开[jsonlint](http://jsonlint.com/)网站页面，在文本框里输入以上内容，验证JSON格式是否合法：

 ![js_data_inter_change_json_07](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_07.gif)
...
&emsp;&emsp;如果在Chrome DevTools控制台上用一个变量保存上述json数据内容，那么就相当于直接声明、创建了一个JS对象：
 ...
 ![js_data_inter_change_json_08](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_08.gif)
...
- JSON数组的写法与JS数组字面量的写法近似，但是JSON数组内部只能包含第四条里面提到的几种类型的value值
 ...
 ![basic_json_object_syntax](http://lemon.lanqiao.org:8082/teaching/img/js/basic_json_object_syntax.png)
...
&emsp;&emsp;我们在实验三一共创建了两个json文件，这样的json文件就可以被用来保存数据。
 ...
 ![js_data_inter_change_json_08](http://lemon.lanqiao.org:8082/teaching/img/js/json_file_logo.png){:width="200px" height="300px"}
...
&emsp;&emsp;下面的图片就完整地解释了JSON格式数据在网站页面上的应用方法：
 ...
 ![JSON_ClientToServer](http://lemon.lanqiao.org:8082/teaching/img/js/JSON_ClientToServer.png)
...
&emsp;&emsp;[JSON.stringify()](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify)的作用是把JS对象转换成JSON字符串。
 ...
 ![js_data_inter_change_json_09](http://lemon.lanqiao.org:8082/teaching/img/js/js_data_inter_change_json_09.gif)
