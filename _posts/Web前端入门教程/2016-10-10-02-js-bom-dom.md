...
&emsp;&emsp;至此，浏览器将会打开一个新窗口，并且按照蓝桥官网的网站地址加载网页。

### 原理解析

&emsp;&emsp;上面的例子，window是一个代表浏览器窗口的JavaScript对象，在这个对象里面定义有多个属性、方法。我们可以通过访问它的属性和方法，查看和操作浏览器窗口。

&emsp;&emsp;window对象上的open方法的作用是根据传入的地址打开一个新窗口,关于这个方法更详细的介绍请参考Mozilla开发者社区的[woindow.open](https://developer.mozilla.org/zh-CN/docs/Web/API/Window/open)方法详细资料。
