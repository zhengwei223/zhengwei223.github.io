...
&emsp;&emsp;在Chrome DevTools Console里面，有一个名称为“window”的JavaScript对象。
 ...
 ![js_dom_bom_in_dev_tools_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_dom_bom_in_dev_tools_01.gif)
...
&emsp;&emsp;它可以让浏览器“听懂”JavaScript语言。借助这个模型，我们可以写出JavaScript代码，查看浏览器关键属性，打开、调整、移动、关闭一个新窗口，同时也可以修改网站页面的结构、内容，样式和行为。它就是一个架设在纯粹ECMAScript和实际各大厂商的浏览器之间的一个桥梁、通道。
 ...
 ![js_bom_bridge](http://lemon.lanqiao.org:8082/teaching/img/js/js_bom_bridge.png){:width="300px" height="200px"}
...
&emsp;&emsp;BOM里面的一切对象都是在浏览器里面可以用JavaScript语言访问、操作JavaScript对象。所有的BOM对象组成了一个类似树形结构，这棵树最顶端的一个对象就是window,这个名字表明它代表了一个打开到一个网页的浏览器窗口。window对象包含若干重要属性、方法和对象，这些正是我们需要关注的主要内容。
 ...
 ![overview_of_bom](http://lemon.lanqiao.org:8082/teaching/img/js/overview_of_bom.gif){:width="500px" height="400px"}
...
&emsp;&emsp;这是浏览器对象模型（BOM）的顶层对象window上的一个重要属性，代表了显示在浏览器窗口里的网页实际内容。
 ...
 ![js_dom_bom_doc_in_dev_tools_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_dom_bom_doc_in_dev_tools_01.gif)
...
&emsp;&emsp;切换到“Console”，通过定义在document上的*getElementById*方法查询td元素，并且声明一个变量保存它。然后就可以通过查询、修改变量的“*innerHTML*”属性来改变单元格显示在网页上的内容了。
 ...
 ![js_dom_bom_doc_in_dev_tools_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_dom_bom_doc_in_dev_tools_02.gif)
...
## 定时工具
 ...
 ![js_dom_bom_doc_in_dev_tools_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_dom_bom_doc_in_dev_tools_03.gif)
...
3. 使用JavaScript代码修改页面元素样式（style）属性
 ...
 ![js_dom_bom_clock_demo_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_dom_bom_clock_demo_01.gif)
...
&emsp;&emsp;其中前三个这些节点对象的类型，有一个共同的“父类”，包括“祖先”:
 ...
 ![html_body_el_tree](http://lemon.lanqiao.org:8082/teaching/img/js/html_body_el_tree.png){:width="200px" height="100px"}
 ![html_body_el_tree](http://lemon.lanqiao.org:8082/teaching/img/js/html_select_el_tree.png){:width="200px" height="100px"}
 ![html_option_el_tree](http://lemon.lanqiao.org:8082/teaching/img/js/html_option_el_tree.png){:width="200px" height="100px"}
...
&emsp;&emsp;点击“Add Row”按钮，给表格添加新的行，你可以在这些新增行里面填写任何内容。
 ...
 ![add_table_row_in_js](http://lemon.lanqiao.org:8082/teaching/img/js/add_table_row_in_js.png){:width="500px" height="400px"}
...
&emsp;&emsp;第一步，我们在“Elements”面板选中超文本元素“我们的服务”，
 ...
 ![select_el_demo](http://lemon.lanqiao.org:8082/teaching/img/js/select_el_demo.png){:width="500px" height="400px"}
...
&emsp;&emsp;第三步，在同一个页面上，找到id是“fullPage”的DIV元素，选中它，
 ...
 ![select_full_page_el](http://lemon.lanqiao.org:8082/teaching/img/js/select_full_page_el.png){:width="500px" height="400px"}
