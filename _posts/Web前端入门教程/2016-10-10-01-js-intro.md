...
&emsp;&emsp;同样，控制台输入下面代码，回车：
 ...
 ![js_tutorial_open_dev_tools_console](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_open_dev_tools_console.gif)
...
&emsp;&emsp;同学们可以按照图片的演示，在控制台执行第二段到第五段代码,并且留意，运算结果是否符合真值表。
 ...
 ![js_tutorial_in_dev_tools_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_02.gif)
...
&emsp;&emsp;在控制台运行代码：
 ...
 ![js_tutorial_in_dev_tools_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_03.gif)
...
&emsp;&emsp;在控制台执行这些代码：
 ...
 ![js_tutorial_in_dev_tools_04](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_04.gif)
...
&emsp;&emsp;在控制台上执行这段代码：
 ...
 ![js_tutorial_in_dev_tools_06](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_06.gif)
...
&emsp;&emsp;我们可以在控制台上很方便地查看对象的内容，[Math对象](http://www.w3school.com.cn/jsref/jsref_obj_math.asp)的属性中有很多是常量，比如圆周率；也有很多是*函数*类型，比如sin、cos这些一眼就能看出来的三角函数。
 ...
 ![js_tutorial_in_dev_tools_07](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_07.gif)
...
&emsp;&emsp;得到实验结果:
 ...
 ![js_tutorial_in_dev_tools_08](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_08.gif)
...
&emsp;&emsp;在控制台运行上面的代码，可以看到：
 ...
 ![js_tutorial_in_dev_tools_09](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_09.gif)
...
&emsp;&emsp;在控制台执行下面的代码：
 ...
 ![js_tutorial_in_dev_tools_10](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_10.gif)
...
&emsp;&emsp;在控制台执行以上代码，可以看到：
 ...
 ![js_tutorial_in_dev_tools_11](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_11.gif)
...
&emsp;&emsp;所有的现代浏览器都内置了一个分析和运行JavaScript代码的小程序，它就是JavaScript引擎。这个引擎不但有独特、复杂的内部结构，而且还会随着浏览器一起升级。
 ...
 ![javascript_engines](http://lemon.lanqiao.org:8082/teaching/img/js/javascript_engines.jpg){:width="400px" height="240px"}

### LiveScript

&emsp;&emsp;网景（NetScape）公司是第一家尝试利用新生万维网的商业企业，它的是主要目标是为所有操作系统的用户提供跨平台一致的互联网使用体验。

 ![father_of_javascript](http://lemon.lanqiao.org:8082/teaching/img/js/brendan-eich.jpg){:width="100px" height="80px"}
...
### Sun公司积极参与
 ...
 ![javascript-vs-java-difference.jpg](http://lemon.lanqiao.org:8082/teaching/img/js/javascript-vs-java-difference.jpg){:width="400px" height="300px"}
...
&emsp;&emsp;坊间早有传闻，大约1994年的时候，财大气粗的微软十分看好网景公司的浏览器业务，因此计划出资收购后者。不知道是什么具体原因，收购的事情没谈下来，微软转回头就开始开发自己的浏览器Internet Explorer(简称IE)。
 ...
 ![ie-vs-netscape](http://lemon.lanqiao.org:8082/teaching/img/js/ie-vs-netscape.jpg){:width="300px" height="300px"}
...
&emsp;&emsp;ECMAScript是一种由Ecma国际（前身为欧洲计算机制造商协会）通过ECMA-262标准化的脚本程序设计语言。 这种语言在万维网上应用广泛，它往往被称为JavaScript或JScript，但实际上后两者是ECMA-262标准的实现和扩展。
 ...
 ![ecmascript-history](http://lemon.lanqiao.org:8082/teaching/img/js/ecmascript-history.png){:width="700px" height="600px"}
...
&emsp;&emsp;JavaScript函数（function）被设计成专门完成一个计算任务的基本运算单位。就像一个机器一样，函数的要做的就是，根据输入，输出计算结果：
 ...
 ![Function_as_machine](http://lemon.lanqiao.org:8082/teaching/img/js/Function_as_machine.jpg){:width="300px" height="200px"}
...
&emsp;&emsp;结果可以看到*arguments*对象里面，保存了外界调用函数时传入的参数。
 ...
 ![js_tutorial_func_arguments_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_func_arguments_01.png)
...
&emsp;&emsp;除了在控制台上直接访问“Math”对象和“Date”函数，我们还在自定义的*函数*内部访问它们。其中*getVolumeOfSphere*的函数体里面就用到了（*Math.PI*）和（*Math.pow*）两个数学函数。
 ...
 ![js_tutorial_in_dev_tools_12](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_12.gif)

&emsp;&emsp;下面是在函数里面创建日期的例子：
 
 ![js_tutorial_in_dev_tools_13](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_13.gif)
...
&emsp;&emsp;在getVolumeOfSphere函数内部，我们把计算得到的球体体积赋值给新声明的变量*volume*。函数执行完以后，这个变量就不存在了：在函数外部也找不到它的声明，更不用提什么赋值和定义了！
 ...
 ![js_tutorial_in_dev_tools_14](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_in_dev_tools_14.gif)
...
&emsp;&emsp;在控制台里面执行代码，可以看到，两种方法创建数组的效果完全相同。
 ...
 ![js_tutorial_array_in_dev_tools_1](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_array_in_dev_tools_1.gif)
...
&emsp;&emsp;上述代码在控制台执行的运行效果如下：
 ...
 ![js_tutorial_array_in_dev_tools_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_array_in_dev_tools_02.gif)
...
&emsp;&emsp;结果如下：
 ...
 ![js_tutorial_array_in_dev_tools_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_array_in_dev_tools_03.gif)
...
&emsp;&emsp;可以在控制台上查看Array.prototype对象：
 ...
 ![js_tutorial_create_obj_in_dev_tools_03_1](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_03_1.gif)


## console计时工具

 ![timer](http://lemon.lanqiao.org:8082/teaching/img/js/timer.png)
...
&emsp;&emsp;在控制台执行上述代码：
 ...
 ![js_tutorial_string_in_dev_tools_04](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_04.gif)
...
&emsp;&emsp;在控制台执行代码，可以看到：
 ...
 ![js_tutorial_string_in_dev_tools_05](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_05.gif)
...
&emsp;&emsp;比较两个字符串是否相同需要用到等性运算符“===”和"=="。在比较字符串的运算过程中，这两个符号的效果是一样的。
 ...
 ![js_tutorial_string_in_dev_tools_06](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_06.gif)
...
&emsp;&emsp;在控制台执行代码，可以看到：
 ...
 ![js_tutorial_string_in_dev_tools_07](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_07.gif)
...
&emsp;&emsp;另外，JS引擎在读取*字符串字面量*时，会悄悄把*字面量*转换成*对象*类型。因此，无论用哪种方法创建字符串变量，我们都能通过新的变量名调用标准库中String类型对象的全部属性、方法。
 ...
 ![js_tutorial_string_in_dev_tools_08](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_08.gif)
...
&emsp;&emsp;在控制台执行代码，可以看到：
 ...
 ![js_tutorial_string_in_dev_tools_09](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_string_in_dev_tools_09.gif)
...
&emsp;&emsp;可以在控制台上查看String.prototype对象：
 ...
 ![js_tutorial_create_obj_in_dev_tools_09_1](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_09_1.gif)
...
&emsp;&emsp;我们不仅可以用数字和文本记录某台汽车各个方面的特征，比如颜色、总重，而且可以通过描述一个*过程*来记录它能干什么，比如发动、加速、刹车等等。
 ...
 ![objectExplained](http://lemon.lanqiao.org:8082/teaching/img/js/objectExplained.png){:width="700px" height="600px"}
...
&emsp;&emsp;一个空对象只需要用一对花括号来表示：
 ...
 ![js_tutorial_create_obj_in_dev_tools_01](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_01.gif)
...
&emsp;&emsp;在控制台执行上述代码，然后查看myCar的内部结构：
 ...
 ![js_tutorial_create_obj_in_dev_tools_02](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_02.gif)

&emsp;&emsp;然后，挨个查看这些属性的内容：

 ![js_tutorial_create_obj_in_dev_tools_02_1](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_02_1.gif)
...
&emsp;&emsp;在控制台执行代码，并且检查对象内部结构、调用myCar对象的方法：
 ...
 ![js_tutorial_create_obj_in_dev_tools_03](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_03.gif)
...
&emsp;&emsp;在控制台重新测试start方法：
 ...
 ![js_tutorial_create_obj_in_dev_tools_04](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_04.gif)
...
&emsp;&emsp;请同学们亲自动手，用这样的方法制造１０台汽车。
 ...
 ![car_objects](http://lemon.lanqiao.org:8082/teaching/img/js/car_objects.png){:width="500px" height="400px"}   更多汽车正在拷贝修改当中......
...
&emsp;&emsp;正如用JavaScript标准库的Array、Date、String函数可以创建对象，我们也可以先定义一个函数，然后把这个自定义函数当成构造器（constructor），创建自己需要的对象。
 ...
 ![constructor_pic](http://lemon.lanqiao.org:8082/teaching/img/js/constructor_pic.png){:width="300px" height="200px"}
...
&emsp;&emsp;并且查看新建对象的关键属性：
 ...
 ![js_tutorial_create_obj_in_dev_tools_05](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_05.gif)
...
&emsp;&emsp;在控制台上执行操作，可以看到：car2和car3上的每一个同名方法都分别指向**两个不同**的函数定义。
 ...
 ![js_tutorial_create_obj_in_dev_tools_06](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_06.gif)
...
&emsp;&emsp;在控制台执行代码：
 ...
 ![js_tutorial_create_obj_in_dev_tools_07](http://lemon.lanqiao.org:8082/teaching/img/js/js_tutorial_create_obj_in_dev_tools_07.gif)
...
&emsp;&emsp;在控制台一次执行start、drive、brake和stop方法，可以看到以下输出：
 ...
 ![myCar_console_output](http://lemon.lanqiao.org:8082/teaching/img/js/myCar_console_output.png){:width="500px" height="400px"}
...
&emsp;&emsp;在调试工具里面查看构造函数（constructor function）的prototype，可以看到：
 ...
 ![func_car_prototype](http://lemon.lanqiao.org:8082/teaching/img/js/func_car_prototype.png){:width="500px" height="400px"}

&emsp;&emsp;在调试工具里面监控“car2”变量的详情可以看到：

 ![car2_method_on_prototype](http://lemon.lanqiao.org:8082/teaching/img/js/car2_method_on_prototype.png){:width="500px" height="400px"}

&emsp;&emsp;在调试工具里面监控“car2”变量的详情可以看到：

 ![car3_detail_about_prototype](http://lemon.lanqiao.org:8082/teaching/img/js/car3_detail_about_prototype.png){:width="500px" height="400px"}
...
&emsp;&emsp;**copy**方法返回了一个跟原对象内容一样的新对象，修改newDate不会影响原来的对象：
 ...
 ![date_copy_effect](http://lemon.lanqiao.org:8082/teaching/img/js/date_copy_effect.png){:width="600px" height="500px"}
...
&emsp;&emsp;控制台输出：
 ...
 ![date_get_weekday_month_name_test](http://lemon.lanqiao.org:8082/teaching/img/js/date_get_weekday_month_name_test.png){:width="600px" height="500px"}
...
&emsp;&emsp;控制台输出：
 ...
 ![date_getlastday_test](http://lemon.lanqiao.org:8082/teaching/img/js/date_getlastday_test.png){:width="600px" height="500px"}
