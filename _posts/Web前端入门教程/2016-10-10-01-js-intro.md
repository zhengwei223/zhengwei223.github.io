...
&emsp;&emsp;用“**typeof**”运算符检查myCar，结果表明它已经是一个“**对象**”了。
...
&emsp;&emsp;正如“世界上没有两片完全相同的叶子”，老司机们一定认同地一句话是：“世界上没有两辆完全相同的汽车”。

&emsp;&emsp;在上路几年之后，每一辆汽车从内到外，每天都在发生各自不同的变化，比如主轴磨损；同一品牌的不同汽车，也会被车主以不同方法操作使用，引起行驶能力的巨大差异：类似，在JavaScript语言中，不同的对象也可以保存不同的**内部状态**，甚至不同的**外部行为**。
