...
&emsp;&emsp;JavaScript函数被设计成专门完成一个计算任务的基本运算单位。就像一个机器一样，函数的要做的就是，根据输入，输出计算结果：
...
&emsp;&emsp;arguments对象里面的元素数字下标从0开始算起，下面的例子里，我们从arguments对象里面取出前两个参数，计算它们的和，并且返回结果：
