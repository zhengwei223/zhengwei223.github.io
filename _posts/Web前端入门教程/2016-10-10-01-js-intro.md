...
description: JavaScript是一种编程语言，你可以用它告诉电脑每一步应该干什么。现在所有的Web浏览器都能理解JavaScript，因此在浏览器里面运行JavaScript代码，你的网页就可能拥有各种令人惊奇的动态效果。
---
...
&emsp;&emsp;布尔运算符：在进行两个布尔值的“*与*”运算时，我们用到了“*&&*”的运算符。

&emsp;&emsp;数学运算符，比如说乘号（*）、大于号（>）和小于号（<）；

&emsp;&emsp;等性运算符：检查两个变量是否相等的（===）和（==）。

&emsp;&emsp;更多的JavaScript语言运算符，你可以直接查看[W3School的运算符页面](http://www.w3school.com.cn/js/js_operators.asp)。
