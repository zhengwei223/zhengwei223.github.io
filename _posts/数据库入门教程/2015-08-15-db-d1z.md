...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在这个阶段，由于网状模型数据库的复杂性、专用性，没有被广泛使用。而在层次模型数据库中，IBM公司的IMS（Information Management System，信息管理系统）层次模型数据库系统则得到了极大的发展，一度成为最大的数据库管理系统，拥有巨大的客户群。
...
![img](/public/img/db/d1z/图1.1 Oracle 11g下载页面.jpg)
...
![img](/public/img/db/d1z/图1.2 Oracle 11g下载全部资料.jpg)
...
![img](/public/img/db/d1z/图1.14 Oracle 11g安装步骤12.jpg)
...
![img](/public/img/db/d1z/图1.15 Oracle 11g安装步骤13.jpg)
...
![img](/public/img/db/d1z/图1.16 Oracle数据库启动与关闭1.jpg)
...
![img](/public/img/db/d1z/图1.19 Oracle企业管理器.jpg)

*图1.19 Oracle企业管理器*
![img](/public/img/db/d1z/图1.20 OEM“方案”页面.jpg)

*图1.20 OEM“方案”页面*

![img](/public/img/db/d1z/图1.21 OEM“服务器”页面.jpg)
...
![img](/public/img/db/d1z/图1.22 SQL Plus界面.jpg)
...
![img](/public/img/db/d1z/图1.23 使用SQL Plus执行SQL语句.jpg)
...
![img](/public/img/db/d1z/图1.24 Oracle Net Manager工具.jpg)

*图1.24 Oracle Net Manager工具*

![img](/public/img/db/d1z/图1.25 网络服务名向导1.jpg)
...
![img](/public/img/db/d1z/图1.28 网络服务名之连接测试失败.jpg)

*图1.28 网络服务名之连接测试失败*

![img](/public/img/db/d1z/图1.29 网络服务名之连接测试成功.jpg)
...
![img](/public/img/db/d1z/图1.30 PLSQL Dev登录Oracle.jpg)
...
![img](/public/img/db/d1z/图1.31 PLSQL Dev主界面.jpg)
