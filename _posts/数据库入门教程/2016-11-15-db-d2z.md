...
![](/public/img/oracle-zq/2.1.png)

*图2.1  EMPLOYEES表数据*

**DEPARTMENTS表（见图2.2）**

![](/public/img/oracle-zq/2.2.png)

*图2.2  DEPARTMENTS表数据*

**JOBS表（见图2.3）**

![](/public/img/oracle-zq/2.3.png)

*图2.3  JOBS表数据*

**LOCATIONS表（见图2.4）**

![](/public/img/oracle-zq/2.4.png)

*图2.4  LOCATIONS表数据*

**COUNTRIES表和REGIONS表（见图2.5和图2.6）**

![](/public/img/oracle-zq/2.5.png)

*图2.5  COUNTRIES表数据*

![](/public/img/oracle-zq/2.6.png)

*图2.6  REGIONS表数据*

**JOB_HISTORY表（见图2.7）**

![](/public/img/oracle-zq/2.7.png)
...
![](/public/img/oracle-zq/2.9.png)

*图2.9  General选项卡*

![](/public/img/oracle-zq/2.10.png)

*图2.10  Keys选项卡*

![](/public/img/oracle-zq/2.11.png)

*图2.11  Checks选项卡*

![](/public/img/oracle-zq/2.12.png)
...
![](/public/img/oracle-zq/2.14.png)

*图2.14  新建一个SQL Window*  

![](/public/img/oracle-zq/2.15.png)
...
使用连字运算符，可以进行字段与字段、字段与表达式、字段与常数值之间的连接，来创建一个字符表达式，连字运算符两边的字段被合并成一个单个的列输出。
...
![](/public/img/oracle-zq/2.20.png)

*图2.20  SELECT存在重复的行* 

![](/public/img/oracle-zq/2.21.png)
