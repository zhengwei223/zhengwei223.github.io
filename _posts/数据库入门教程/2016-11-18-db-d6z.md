...
![](/public/img/oracle-zq/6.3.png)

*图6.3  Views文件夹*  

右击该视图，选择Query data选项获取数据，部分显示结果如图6.4所示。

![](/public/img/oracle-zq/6.4.png)
...
修改序列的语法和创建序列类似，只是将CREATE改成了ALTER，且START WITH选项不可以修改，具体语法形式如下： 
