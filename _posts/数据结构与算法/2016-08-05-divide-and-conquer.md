...
description: 本章我们了解分治法的基本设计思路，并学习归并排序算法
author: 郑未
...
![Alt text](/public/img/algorithm/dcc-1.jpg)
...
![Alt text](/public/img/algorithm/dcc-2.png)
...
![Alt text](/public/img/algorithm/dcc-3.png)
...
![Alt text](/public/img/algorithm/dcc-4.png)
...
![Alt text](/public/img/algorithm/dcc-5.png)
...
具体代码见[归并算法](/数据结构与算法/Merge-Sort)

## 2.3-3

使用数学归纳法证明：当n刚好是2的幂时，以下递归式的解是T(n)=nlgn。

![Alt text](/public/img/algorithm/dcc-6.png)

![Alt text](/public/img/algorithm/dcc-7.png)
...
![Alt text](/public/img/algorithm/dcc-8.png)
...
![Alt text](/public/img/algorithm/dcc-9.png)

伪代码（递归模式）：

![Alt text](/public/img/algorithm/dcc-10.png)
