...
![典型技全栈术模型](/public/img/manual/manual001.png)

![典型技全栈术模型](/public/img/manual/manual002.png)
...
![典型技全栈术模型](/public/img/manual/manual003.png)
...
![典型技全栈术模型](/public/img/manual/manual004.png)
...
![典型技全栈术模型](/public/img/manual/manual005.png)

我们通过以下命令查看刚才安装的mysql数据库版本信息

![典型技全栈术模型](/public/img/manual/manual006.png)
...
![典型技全栈术模型](/public/img/manual/manual007.png)
...
![典型技全栈术模型](/public/img/manual/manual008.png)

![典型技全栈术模型](/public/img/manual/manual009.png)

然后sql，右键点击数据库lanqiao，选择点击 运行Sql文件…选项。

![典型技全栈术模型](/public/img/manual/manual010.png)

点击文件后面蓝色箭头指向的按钮来选择文件，选择lemon.sql文件后，选择后点击  开始。

出现下图页面，证明倒入成功。

![典型技全栈术模型](/public/img/manual/manual011.png)
...
![典型技全栈术模型](/public/img/manual/manual012.png)

#### 3.4.2. 使用如下命令解压到当前文件夹下：

![典型技全栈术模型](/public/img/manual/manual013.png)

解压后：

![典型技全栈术模型](/public/img/manual/manual014.png)

#### 3.4.3. 测试tomcat是否安装成功

192.168.10.4:8080出现如下页面则表面服务器端tomcat安装成功！

![典型技全栈术模型](/public/img/manual/manual015.png)

### 3.5.	将lemon项目部署到服务器

部署之前首先找到tomcat的bin 目录并关闭tomcat服务器如下图：

![典型技全栈术模型](/public/img/manual/manual016.png)

通过SSH远程连接工具将事先备好的lemon.war放到tomcat webpp目录下：

![典型技全栈术模型](/public/img/manual/manual017.png)

回到bin目录重新启动tomcat：

![典型技全栈术模型](/public/img/manual/manual018.png)
...
![典型技全栈术模型](/public/img/manual/manual019.png)

默认账户dyt@lanqiao.org，密码111111，登录后主页面如下图所示：

![典型技全栈术模型](/public/img/manual/manual020.png)
...
![典型技全栈术模型](/public/img/manual/manual021.png)

设置防火墙：

![典型技全栈术模型](/public/img/manual/manual022.png)
